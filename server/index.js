...
app.use("/api/doors",       auth, checkAccess,  require("./routes/doors")); // Door knocking tracker — all plans
app.use("/api/integrations", auth, checkAccess, requirePlan("pro"), integrationsRouter);  // SWFT+ and above
